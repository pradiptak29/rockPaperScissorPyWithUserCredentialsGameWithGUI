...
if 'asterix_29' == _id.lower():
    ...
    if 'pop12345xy' == b.lower():
        ...
        def clicked():
            ...
            name_entry = Entry(opening_window, textvariable=name_var, font=('calibre', 18, 'bold'), bg="white",
                               fg="black")
            name_entry.grid(row=1, column=1)
            sub_btn = Button(opening_window, width=10, height=1, font=('calibre', 12, 'bold'), bg="#1dd909",
                             text='Submit', command=submit)
            sub_btn.grid(column=1, row=2)


        play_btn_yes = Button(opening_window, width=10, height=1, font=('calibre', 12, 'bold'), text="Yes",
                              bg="#1dd909", fg="white", command=lambda: clicked())
        play_btn_no = Button(opening_window, width=10, height=1, font=('calibre', 12, 'bold'), text="No", bg="#ed3305",
                             fg="white", command=lambda: opening_window.destroy())
